...
export class Line extends SampleBase {
    render() {
        return (<div className="control-pane">
            ...
            }} chartArea={{ border: { width: 0 } }} tooltip={{ enable: true }} legendSettings={{ enableHighlight: true }} width={Browser.isDevice ? '100%' : '75%'} title="Crude Steel Production Annual Growth" loaded={this.onChartLoad.bind(this)}>
